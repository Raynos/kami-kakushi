...
flags: r3-hold
bonus: +1 agi — "For six nights the wolf does not come, and you learn its hours
  anyway: the straw settling, the wind at the bar, the one sound that is neither. By
  the last night you are up off the sill before you know which it was. (+1 AGI)"
