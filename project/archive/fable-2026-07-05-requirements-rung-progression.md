...
**Status:** ✅ DONE (Fable session, 2026-07-07) — all 7 phases landed
(e13eb7a → 447d894); design locked 2026-07-05. **Open follow-ons:** the
ADR-139 per-rung flavor diverge bundles (human call 2026-07-07); the parked
R4+ predator-kill requirements (await a combat-curve retune — see
requirements.md's note + the 8bdf044 body); HR-12 + the t0-story reading-queue
sign-off await the human.
