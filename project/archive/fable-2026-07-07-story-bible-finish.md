...
**Status: ✅ DONE (2026-07-09) — the reboot's spirit is complete; archived.**
Workstream A (the BIBLE) finished s109 and the human signed off the whole read
s116. Workstream B (the ripple/build wave) shipped as the two parallel storywave
plans — **Plan B (game) shipped v0.4.0** and **Plan A (docs) A0–A5 complete**,
both now in `project/archive/`. The bible build wave is closed. The execution plan for finishing what the
