...
4. **Next (autonomous):** drain the playtest inbox (`/drain-inbox`) as the human QAs;
   or the T2 §6.1 rungs/fog; un-park Plan K / the T1 plan on the human's call.
5. **Shared tree:** stage only your own files by explicit pathspec commit.

<!-- rewrite-debt: 0/20 · last full rewrite: 2026-07-09 -->
