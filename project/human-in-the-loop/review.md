...
> **In the DEV panel:** line names the surface/bundle **id** to click
> (`market`, `sleep-announce` — ids are stable, ADR-192; the old
> positional `V<n>`/`SV<n>` tags renumbered on every insert/prune and
> are dead), and each DEV row carries its **HR-n** chip back to this
> file. The two are bound by the **`review-link`** gate: a toggle naming
> a closed or missing item, an item missing its id line, or a citation
> of a pruned/foreign id all go RED (`npx tsx
> src/scripts/verify-review-link.ts` names every one).
...
### HR-1 🔲 [rung] — {what to review}
  ...
  - **In the DEV panel:** Review → Variants|Story → **id** (the
...
Travelling market"):
  ...
  - **In the DEV panel:** Review → Variants → **market** <!-- dev-tags:
    kept true by the review-link gate -->
  - **Verdict:** _(awaiting your pick)_
...
(R7). Three live takes ("VARIANT · House-Influence grade"):
  ...
  - **How to look:** `pnpm run dev` → reach R3 → DEV → Variants →
    ...
    banking (R7).
  - **In the DEV panel:** Review → Variants → **influence** <!--
...
(scout-by-fighting).
  ...
  - **How to look:** `pnpm run dev` → reach R3 (`__qa.toRung('R3')`) →
    **Combat** tab → toggle "VARIANT · Bestiary"; fight a foe to see an
    entry ink in.
  - **In the DEV panel:** Review → Variants → **bestiary** <!--
    dev-tags: kept true by the review-link gate -->
  - **Verdict:** _(awaiting the human)_
...
intent):
  ...
  - **In the DEV panel:** Review → Variants → **home** <!-- dev-tags:
    kept true by the review-link gate -->
  - **Verdict:** _(awaiting your pick)_
...
live takes ("VARIANT · Crafting"):
  ...
  - **In the DEV panel:** Review → Variants → **craft** <!-- dev-tags:
    kept true by the review-link gate -->
  - **Verdict:** _(awaiting your pick)_
...
Quests"):
  ...
  - **How to look:** `pnpm run dev` → reach R5 → **Quests** tab → DEV →
    Variants → "Quests".
  - **In the DEV panel:** Review → Variants → **quests** <!-- dev-tags:
    kept true by the review-link gate -->
  - **Verdict:** _(awaiting your pick)_
...
`docs/content/t0-story.md`); alternates + briefs: `takes/c5a-overlays/`.
  ...
  - **In the DEV panel:** Review → Story → **c5a-overlays** <!--
    dev-tags: kept true by the review-link gate -->
...
alternates: `takes/c5a-discoveries/`.
  ...
  - **In the DEV panel:** Review → Story → **c5a-discoveries** <!--
    dev-tags: kept true by the review-link gate -->
  - **Verdict:** _(awaiting your read)_
...
`narrative/flavor.md`; alternates: `takes/c5a-judge/`.
  ...
  - **In the DEV panel:** Review → Story → **c5a-judge** <!-- dev-tags:
    kept true by the review-link gate -->
  - **Verdict:** _(awaiting your read)_
...
(per-take briefs + scorecards in each bundle.md).
  ...
  - **In the DEV panel:** Review → Story → **c5a-nodes-autumn** ·
    **c5a-nodes-bon** · **c5a-nodes-newyear** **c5a-nodes-spring** ·
    **c5a-nodes-summer** · **c5a-nodes-winter** <!-- dev-tags: kept true
    by the review-link gate -->
...
`takes/hd36-lord-unstaged/`.
  ...
  - **In the DEV panel:** Review → Story → **hd36-lord-unstaged** <!--
    dev-tags: kept true by the review-link gate -->
  - **Verdict:** _(awaiting your read)_
...
alternates + briefs + Pass-1 constraint brief: `takes/works-cause/`.
  ...
  - **In the DEV panel:** Review → Story → **works-cause** <!--
    dev-tags: kept true by the review-link gate -->
  - **Verdict:** _(awaiting your read)_
...
- **Works 普請** (the projects/upgrades surface) — ✅ **all three LIVE in
  ...
  - **In the DEV panel:** Review → Variants → **works** <!-- dev-tags:
    kept true by the review-link gate -->
  - **Verdict:** _(awaiting your read)_
...
instead — it is a one-constant flip, no rework.
  ...
  - **In the DEV panel:** Review → Variants → **zone-reveal** <!--
    dev-tags: kept true by the review-link gate -->
...
the three wrote, and it can be grafted.
  ...
  - **In the DEV panel:** Review → Story → **zone-reveals** <!--
    dev-tags: kept true by the review-link gate -->
...
- Alternates: **A** "the book speaks" (the terms read aloud as a ledger
  ...
  - **In the DEV panel:** Review → Story → **hd38-w1-terms** <!--
    dev-tags: kept true by the review-link gate -->
  - **Verdict:** _(awaiting your read)_
...
- **One thing I want from you:** take B wrote *"The head arrives late,
  ...
  - **In the DEV panel:** Review → Story → **hd38-w4-intro** <!--
    dev-tags: kept true by the review-link gate -->
  - **Verdict:** _(awaiting your read)_
...
- Alternates: **A** "the land is not a metaphor" (clearest, flattest —
  ...
  - **In the DEV panel:** Review → Story → **hd38-w2-works** <!--
    dev-tags: kept true by the review-link gate -->
  - **Verdict:** _(awaiting your read)_
...
- Alternates: **A** *"the day spent like coin"* (the deliberate spender
  ...
  **B** *"the day heard from sleep"* (the estate's working day as the
  ...
  - **In the DEV panel:** Review → Story → **adr187-sleep** <!--
    dev-tags: kept true by the review-link gate -->
  - **Verdict:** _(awaiting your read)_
...
- **Verdict:** _(awaiting your read)_
  ...
  - **In the DEV panel:** Review → Story → **sleep-announce** <!--
    dev-tags: kept true by the review-link gate -->
...
**How to review it LIVE** (never from this page):
  ...
  - **In the DEV panel:** Review → Story → **adr190-nudge**
