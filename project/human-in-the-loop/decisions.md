...
- **Resolution:** Absorbed by **H10 (Operating Model v2)** — decide there (the v2-lite reel-back maps the ship-gate/manifest scope). → [`../human-feedback/2026-06-29-decision-session.md`](../human-feedback/2026-06-29-decision-session.md).
...
- **Resolution:** Absorbed by **H10 (Operating Model v2)** — decide there. → [`../human-feedback/2026-06-29-decision-session.md`](../human-feedback/2026-06-29-decision-session.md).
