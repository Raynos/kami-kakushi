...
- **Resolution:** ✅ (2026-06-29 decision session) — ship the **real D-049 pacing** as default (T0 ~10–15 min/rung, floor-exempt; T1 ≥30 min/rung) + a **DEV-only 2×/4×/8× speed toggle** (time multiplier, *not* a Demo/Real fork); supersedes D-047's DEMO-default. → [`../feedback/2026-06-29-decision-session.md`](../feedback/2026-06-29-decision-session.md) (LOCKED #1); ADR lands at D-056+ in [`../../docs/living/decisions.md`](../../docs/living/decisions.md) (batched ripple).
...
- **Resolution:** ✅ (2026-06-29) — resolved by the tier **reshape**: a spine-first T0 tutorial + a real **T0→T1 ascension milestone** (a big ceremonial beat, D-055) replaces the locked-teaser stopgap (D-048/D-049 + the reshape directive; teaser presentation per D-055). → [`../feedback/2026-06-29-decision-session.md`](../feedback/2026-06-29-decision-session.md); ADRs D-048…D-055 + D-056+.
...
- **Resolution:** Absorbed by **H10 (Operating Model v2)** — decide there (the v2-lite reel-back maps the ship-gate/manifest scope). → [`../feedback/2026-06-29-decision-session.md`](../feedback/2026-06-29-decision-session.md).
...
- **Resolution:** ✅ (2026-06-29) — **split** `prd.md` into per-section files (`prd/§1…§7.md`) + a tiny completeness check, **as part of** the batched PRD ripple (mechanical, zero content change; removes the truncation failure class). → [`../feedback/2026-06-29-decision-session.md`](../feedback/2026-06-29-decision-session.md) (#6); ADR D-056+.
...
- **Resolution:** Absorbed by **H10 (Operating Model v2)** — decide there. → [`../feedback/2026-06-29-decision-session.md`](../feedback/2026-06-29-decision-session.md).
...
- **Resolution:** _open_ — **still 🔲 OPEN** (human reviews op-model v2 separately, ~1 hr). The 2026-06-29 decision session **reeled v2 back** as an overengineered draft; review the **v2-lite reel-back** ([`../../docs/plans/operating-model-v2-lite-reelback.md`](../../docs/plans/operating-model-v2-lite-reelback.md)) instead, with the nested roadmap re-axe + `diverge`-mandatory gate as inputs. **Absorbs H7 + H9.** (The v2 _bundle_ awaits review; this is not a repo freeze — individual improvements are greenlit ad hoc, e.g. the `tdd` skill 2026-06-29.) → [`../feedback/2026-06-29-decision-session.md`](../feedback/2026-06-29-decision-session.md) (#4, #9–#11).
