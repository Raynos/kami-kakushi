...
> tracker [`../../project/status/pending-prd-reshape.md`](../../project/status/pending-prd-reshape.md); and (c)
...
- **B · The ripple (the big one).** Apply the reshape + this session's design across the PRD, living docs,
  ...
  ([`../../project/status/pending-prd-reshape.md`](../../project/status/pending-prd-reshape.md)) — its three
