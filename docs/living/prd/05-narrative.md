...
> authored in v1 (Q8); the **castle-town / Daikan first-contact** T4 stub (Q24); **one co-located weir-jizō
...
>
> **Reshaped by the 6-tier split (D-048…D-066, 2026-06-29).** The old single **Estate** tier is split: **T0 =
> tutorial** (showcase-in-miniature, R0→R7, **Estate 家産** only, the BIG first ascension) + **T1 = the full
> estate** (R8→R15, **Arms 武威** reveals, E1→E2, the first paid retinue, the sword line, the two-pillar gate that
> opens the valley); the Village (Asagiri) is now **T2**, the Region **T3**, Castle-town **T4**, Edo **T5**
> (pillar-reveal ramp **1→2→3→4→4**). §3 re-placements rippled here: the **sword line → T1**, the **staff line
> pulled forward → T2 Village** (roster complete by end-T2; T3 Region = combat depth), **rival houses
> introduced + the contest begun at T2** (climax at T3), **cross-pillar combos partial at T2 / full at T3**.
> Pillar kanji, the **trade ≤⅓** and **70/30** invariants are unchanged.

# T0 — Estate (tutorial; v1)

> **STATUS: reshaped by D-048 (the 6-tier split).** The old single **Estate** tier is split in two: **T0 (this
> section) is the tutorial — a showcase-in-miniature** that climbs the estate rungs **R0→R7** and reveals only
> the **Estate 家産** pillar (P1); the **real 30-min-floor estate grind is the new T1 — Estate (full)**, which
> climbs **R8→R15** and reveals **Arms 武威** (P2). The Village (Asagiri) is now **T2**, the Region **T3**,
> Castle-town **T4**, Edo **T5** (D-048; the pillar-reveal ramp is **1→2→3→4→4**). §5 owns the *story shape*;
> the rung-meter curve / gate thresholds defer to §3/§4.

## T0.1 Overview

**Theme:** *earn your keep and a place at the table.* One declining hill estate — the Kurosawa *gōshi* house in
Asagiri valley — unlocked across a **small walkable map** (D-065). A half-drowned, nameless young man (~18–20),
...
easy**, D-061): its quick ~10–15-min rungs are **floor-exempt** (the ≥30-min/rung floor binds only from T1,
D-049), yet the bite never lets up within guardrails (winnable · soft-setback only · no permanent loss · no
stranding). T0 is the **showcase-in-miniature** (D-052): a tiny taste of every system — a koku flywheel, one
craftable weapon, a tiny market, a walkable map, the Estate pillar, the first ascension — each **deepened in
T1**. Onboarding is **non-hand-holdy** — taught by a **diegetic mentor** (D-063): **Genemon** for labour/koku ·
**Kihei** for arms/combat · **Sōan** for healing — reveal-as-plot, **never popups** (D-015).
...
revealed** — it surfaces only at the ascension and **names in T1** (D-048). **Phase 2** — the **capstone (R7)
...
ONE open pillar — which collapses to EXCELLENT in Estate** (Q7/FU10/D-049: `1 EXC + 1 GRT + (N−2) GOOD` with
N=1). Meeting it only **unlocks the OPTION**; the tier-up is a **manual opt-in story event** the player triggers
(grinding Estate past the line earns a better, **grade-scaled boon**, D-049). Diegetically: the humbling first
...
> **The first ascension lands BIG (binding — D-062).** The **T0→T1 ascension is the first**, and it **always
> lands big on first contact regardless of grade**: a held **Yuji Syuku title card** brush-wipes in to name the
> new standing, the **locked pillar silhouettes stir** (the next, still-**unnamed** silhouette un-greys — T1 will
> name it **Arms 武威**, D-055), a **dream/mystery beat** fires (the §1.9 cadence; Origin stays dark), the audio
> **swells** (taiko roll + temple-bell 鈴, cross-ref `ui-design.md` §6.7 / `sfx-spec.md`), and the **grade-scaled
> boon** is revealed. Overshoot-grade *boon magnitude* still scales (D-049); the *ceremony* is grade-independent
...
7. **Basic repairs, the capstone & the first ascension (the gate).** Drive the kura repair and complete the
   ...
   家産 pillar** beside **locked, still-unnamed silhouettes** (D-055). In Phase 2 the **Estate DEEDS now accrue**:
   ...
   reveals at the ascension and **names in T1**, FU14/FU7.) Clearing T0's **single-pillar gate — EXCELLENT in
   Estate** (the N=1 collapse of the scaled grade-gate, D-049) — edges the house off the foreclosure cliff. The
   player then triggers the **manual opt-in first ascension**, which **lands BIG on first contact** (D-062 — the
...
**Areas (T0 estate + the shared near-wilderness ring — navigable nodes on the **small walkable map** (D-065),
...
debt, and arms all **scale into real depth** (D-052), and the mediocre-start protagonist becomes a genuinely
...
(placeholders; §3 / fork#3). This is where the **≥30-min/rung floor BINDS for the first time** (D-049/D-056 — T0
was floor-exempt); Phase-1 runs a provisional **~5–8h** (re-derives in the §4.8 6-tier rescale). Difficulty
stays **humbling THROUGHOUT** within guardrails (D-061). The estate's domain is still **its own land** — the
valley does **NOT** open until the Arms ascension fires at tier-end.

> **Progression shape (binding) — climb the rungs (Phase 1), then the estate-influence grind (Phase 2)**
> (FU7; §1.6.4/§4.0.1). T1 runs the same two-phase motion on a **two-track rung-meter**: Phase 1 climbs R8→R15 on
...
**Transition gate (T1→T2) — the two-phase shape (FU7).** **Phase 1** — climb **R8→R15** (the full-estate
...
**HYBRID two-pillar gate** (Q7/FU10/D-049): **exactly 1 GREAT + 1 EXCELLENT** across Estate + Arms, **both ≥
...
D-049). Diegetically: the house solvent and self-defending, its books in the black → the estate trusts him to
**carry its business beyond its own gate**, into the valley. **Estate stage span:** E1 Stabilising → **E2
Recovering** (cross-ref §1.5.1; D-066's koku flywheel branches into LAND/TREASURY/TRADE this tier).
...
Combat-Rank, AND-gated). The tier's **pillar DEEDS are gated to Phase 2** (post-R15; FU7); combat clears advance
...
1. **Past the bailiff's post (R8, Kura Warden).** The tutorial's quick taste gives way to a **genuine grind** —
   ...
   **LAND / TREASURY / TRADE** capped sub-engines (D-066/D-051/D-008; trade hard-capped **≤⅓** of Estate &
   Wealth).
...
5. **The Arms 武威 pillar reveals (Armsman of the House).** Kihei **names** the pillar un-greyed at the
   ...
   **deed ACCRUAL stays Phase-2-gated** (FU7; banks only post-capstone). The three combat tracks stay clean:
...
6. **The first paid retinue (after E2).** Hire the first men-at-arms, **Gohei & Yatarō** (ex-*ashigaru* off the
   ...
   they help **without trivialising the humbling tune** (D-061).
...
8. **Trusted Man of the House (R15) — the capstone, the two-pillar grind & the Arms ascension (the gate).** Reach
   ...
   **next (3rd, still-unnamed) silhouette stirs** (T2 names it **Office 官威**, D-055), a **dream/mystery beat**
...
failed flood-venture — now **fought and resolved** by the full-estate grind (canon §F: a circumstance, **not** a
...
- **Resolution (purely economic, multi-route):** **Peaceful** — out-grind the interest through the **TREASURY**
  ...
  `choices[]`/`ChoiceId`, `content/dialogue.ts`; deterministic; only chosen-flags persist; Q34/FU22.)*
...
> Estate physical growth is **flavour you can see**, not a sim. *(E2→E3+ provisionally **slips to T2+** per the
> roadmap's flagged ambiguity #1 — see "uncertainties".)*

## T1.5 Key NPC & dialogue beats

- **Genemon** — still the spine's gatekeeper; the **labour/koku mentor** (D-063), now teaching the branched
  flywheel as *story*, never a popup.
- **Kihei** — the **arms/combat mentor** (D-063): turns the humbling fight into discipline, opens the sword line,
...
Satoyama** danger ring now patrolled (foraging groves, bamboo stand, the charcoal-burners' edge) — reveal-per-beat
(D-065). The valley itself stays **locked** until the Arms ascension (the T2 teaser shows it at tier-end).

**Mob roster (grounded; the v1 ~5-mob set deepens; conditioning-gated; cross-ref §1.13):** the T0 set returns at
...
> **FOUND-gear & the growing roster (FU13/Q15).** The Near Satoyama's beasts feed the **loot→craft loop**; this is
...
# T2 — The Valley (estate domain expands) (v1 full)
...
> **Progression shape (binding) — climb the rungs (Phase 1), then the estate-influence grind (Phase 2)**
> (FU7; §1.6.4/§4.0.1). T2 repeats the two-phase motion on a fresh ladder: **Phase 1** climbs **V0→V7** on the
...
**Transition gate (T2→T3) — the two-phase shape (FU7).** **Phase 1** — climb **V0→V7** (*"clean your room"*):
...
**Estate stage:** **E2 Recovering (held)** — E1→E2 landed in T1; *E2→E3+ provisionally slips toward the Region
per ambiguity #1* (the E3 Prosperous payoff is T3.4).
...
> **What's net-new at the Village (D-048 reshape).** This is the **first tier OUT** (the Arms ascension just
...
> T1; E2→E3+ slips toward the Region per ambiguity #1).
...
6a. **Shoulder to shoulder with Naoyuki (rivalry → grudging respect). [THREAD: Naoyuki]** A shared danger —
   ...
   rivalry seed and the G5 rival→ally flip** (T3.3) so the conversion reads as **earned**, not abrupt (Q26).
7. **Right-hand-in-waiting (V6) — agent over the valley; the rivals appear.** The lord first believes the house's
   ...
   (D-031/§4.3.1). The **climax** — the G5 Naoyuki ally-flip, the G7 dethroning — is **held for the Region (T3).**
...
the estate **consolidates at E2** while the valley starts **crediting the Kurosawa's hand** again. **E2→E3+
provisionally slips toward the Region (T3) per ambiguity #1** — the heavier prosperity build pays out at **E3
Prosperous (T3.4).**
...
> from the Region into the Village** (D-052/§3), found and refitted rather than gifted — so the **roster is
...
# T3 — Region (v1 full; the personal-mystery payoff lands here)
...
> **Progression shape (binding) — climb the rungs (Phase 1), then the estate-influence grind (Phase 2)**
> (FU7; §1.6.4/§4.0.1). T3 repeats the two-phase motion: **Phase 1** climbs **G0→G7** on the **curated per-rung
...
**Transition gate (T3→T4) — the two-phase shape (FU7).** **Phase 1** — climb **G0→G7**: *win the region* (the
...
The T3 antagonist is the **two rival houses** (canon §F: exactly two) — the region's **incumbent samurai
houses** when the Kurosawa arrive — with the scarred *rōnin* **Hanzaki** as the dangerous combat beat. **Tomita
(= money) & Akagi (= honour) were INTRODUCED and the contest BEGAN back at the Village (T2.2/T2.7 — D-048/§3);
...
- **Jinpachi** (father, ~50; a senior porter long away on a far stretch of the *kaidō* — **known alive but
  ...
  at T3** alongside the rest of the family, with an **optional later emotional callback at T5** (the recovered
...
**Areas (T3 region; v1 cut-set; cross-ref §1.7 / §1.7.1):**
...
- **The Kaidō Porters' & Transport Guild** *(T3 trade-backbone)* — routes, *sekisho* pass-tiers, route-risk; the
  trade backbone (met via Kanta's first favour run). **This is a T3 node, NOT the T4 cliff-hanger stub** — the v1
  T4 stub is the **castle-town / Daikan first-contact** (Q24; see the T4 header). The porter/transport guild
...
> **FOUND-blades & combat DEPTH — no new line (FU13/Q15; D-052/§3).** The region's better-trained human threats
...
# T4 — Castle-town (STUB in v1)

> **v1 ships a STUB cliff-hanger only** (canon §I; Q24). The single buildable T4 node for v1 is the
> **castle-town / Daikan first-contact**: a **sealed summons** delivered after the T3 capstone, **presenting
...
> *(This **replaces** the old "Kaidō Porters' & Transport Guild first-contact" stub — that re-ran spent T3
> content; the porter/transport guild stays a **T3** trade-backbone node, T3.6.)* The T3 capstone opens onto
> exactly this one castle-town teaser, then ends. **Everything below is authored-forward (not built in v1).**

## T4.1 Overview (forward)
...
**Estate stage span:** E3 Prosperous → E4 Fortified Seat *(E3 already attained in v1's T3 per Q8; T4-forward
starts from E3).*

## T4.2 Main-quest beats (forward stub)
...
2. **The townhouse beachhead.** Secure a modest rented castle-town townhouse — a single bare room with a gate,
   mirroring the T0 kura cold-open (the T4 hub through which introductions route). **— end of the v1-built stub;
   the T3 capstone opens onto exactly this, then ends.**
...
## T4.3 Antagonist arc — **Tedai Kuroiwa**, the gracious door (forward)
...
## T4.4 Estate roster & buildings (forward) — E3 → E4
...
the invented T5-era ghost-story beat is **deleted** (it would breach the ≤1 ambiguity cap; canon §1.13).

> **Parked — later (designed, not authored as full v1 content):** estate stages **E4–E5** in full *(E3
> Prosperous is **un-parked** — authored in v1's T3; Q8)*; the marriage/adoption brokerage depth; the
...
## T5.3 Antagonist arc — the Edo factor + the impartial test (roadmap)
...
## T5.4 Estate roster & buildings (roadmap) — E5 Restored-and-Surpassed
...
## T5.5 Endgame, succession & epilogue (roadmap)
...
- **Numbers belong in §4.** Every "result," "threshold," "result-recorded," and pillar-gate here is a **shape**;
  ...
  archetype params** + the growing roster (FU13/§4.6), and the **cross-pillar combos** (the **PARTIAL Office-pairs
  set at T2 Village**, the **FULL 4-pillar set at T3 Region** — the late-game anti-slump; FU20/§4.3.1). §5 keeps
...
- **Rung copy belongs in §3.** T3's region-ladder rung wording, all per-tier reveal cadences, **the staggered
  ...
  line (staff, pulled forward)**; FU12),
...
- **Authenticity pass — RESOLVED (2026-06-25).** The **Standing & Office** pillar kanji is set to **官威
  ...
  in-house role the estate confers, not an attested bakufu office); and the **T5** arc has the house **staff and
...
- **Name fictionalisation (Q11/Q39/Q27/Block N.1 #3) — lint-guarded.** The invented replacements used in §5 are
  **Heita** (T0 field-lad, off **Magobei**), **Obaa Kuni** (village herbalist, off **Sayo**), **Mosuke** (T4
  clerk, off **Naoyuki**), **Hayami** (T5 touring inspector, off the real "Toyama"), **Mukai** (T5 rusui, off
...
1. **Authenticity pass — RESOLVED (2026-06-25).** The Standing & Office pillar kanji = **官威 (*kan'i*)**; R7 =
   **地方役 (*jikata-yaku*)** (home-field bailiff); *michi-ban* stays **diegetic-only**; **T5** = the house runs
   the *domain's* Edo conduit (*rusui-yaku* under the daimyō's *sankin-kōtai*), not its own. A routine confirm of
   humble *ashigaru*/household-tier title vocabulary vs aspirational narration may still run before T0–T3 dialogue
...
2. **Jinpachi = estranged-living, NOT a second resurrection (RESOLVED — D-Q-Oyuki).** Reworked so the father is
   **alive but long estranged** (away on the *kaidō* for years) and his T3 beat is a **reconciliation**, **not**
...
4. **Kuzuhara has NO survivor / co-investigator character (CUT).** Per human review the stale fellow-survivor-
   ...
   Kuzuhara is purely a struggling, depopulated upstream hamlet the player resettles as a T3 region project; the
...
5. **T4/T5 are forward-authored only.** Per canon v1 scope: the **T4 stub = the castle-town / Daikan
   ...
   dropped); **T5 roadmap.** Estate now grows **E0→E3** in v1 (**E3 Prosperous** authored; **E4–E5** parked; Q8).
   Confirm the chosen T4 stub node and that the parked/cut lists (**E4–E5** depth; Matagi / Pilgrimage /
