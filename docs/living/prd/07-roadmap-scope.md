...
| **Crafting** | **hybrid**: simple recipes from T0-R4; the component/quality system from T2-V3 (the Village). Crafting + quests are capabilities **homed within the six-tab IA** (Work · Map · Estate · Inventory · Character · Combat — **D-112**; exact tab per `ui-design.md`), superseding the earlier "own top-level tab" framing | §4.7.2, §2.11/§2.12, §3.4 |
