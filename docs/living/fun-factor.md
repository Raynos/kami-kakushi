...
> [`qa-playtesting.md`](../guides/qa-playtesting.md) §3 is the harness that **measures** them; the
...
built and instrumented (`window.__qa.pacing()`, report-only) in [`qa-playtesting.md`](../guides/qa-playtesting.md)
